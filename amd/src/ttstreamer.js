    ...
    return {
        ...
        * turns (they get overwritten) and every word timing after the refresh points back at the start of the audio.
        ...
        preparesocket: function () {
            ...
            // format_turns gives punctuated, capitalised turns. Solo counts sentences and grades grammar, so it needs
            // them. Both models need the flag: the multilingual model does not format on its own, whatever the
            // AssemblyAI docs say (tested 2026-09-22, see forclaude/solo-streaming-plan.md, Phase 0 findings).
            var query = 'sample_rate=16000&encoding=pcm_s16le&speech_model=' + themodel + '&format_turns=true'
