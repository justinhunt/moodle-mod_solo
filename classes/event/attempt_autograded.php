...
/**
 * The mod_solo attempt autograded event.
 *
 * @package    mod_solo
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_autograded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsoloattemptautograded', constants::M_COMPONENT);
    }
