...
if ($ADMIN->fulltree) {
    ...
    if (!empty($cloudpoodllapiuser) && !empty($cloudpoodllapisecret)) {
        ...
        $amddata = \mod_solo\cbcredentials::export_buttons_data(
            '#id_s_mod_solo_apiuser',
            '#id_s_mod_solo_apisecret'
        );
    ...
    $settings->add(new admin_setting_configcheckbox(
        constants::M_COMPONENT . '/multipleattempts',
        get_string('multiattempts', constants::M_COMPONENT),
        get_string('multiattempts_details', constants::M_COMPONENT),
        0
    ));
    ...
    */
    ...
    $settings->add(new admin_setting_configselect(
        constants::M_COMPONENT . '/showgrammar',
    ...
    $settings->add(new admin_setting_configselect(
        constants::M_COMPONENT . '/showspelling',
    ...
    $settings->add(new admin_setting_configselect(
        ...
        '',
        constants::M_LAYOUT_NARROW,
        $layoutoptions
    ));

    $settings->add(new admin_setting_confightmleditor(
        constants::M_COMPONENT . '/speakingtips',
        get_string('speakingtips', constants::M_COMPONENT),
        get_string('speakingtips_details', constants::M_COMPONENT),
        get_string('speakingtips_default', constants::M_COMPONENT)
    ));

    $settings->add(new admin_setting_configtext(
        constants::M_COMPONENT . '/attemptsperpage',
        get_string('attemptsperpage', constants::M_COMPONENT),
        get_string('attemptsperpage_details', constants::M_COMPONENT),
        10,
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configselect(
        constants::M_COMPONENT . '/gradingsperpage',
        get_string('gradingsperpage', constants::M_COMPONENT),
        get_string('gradingsperpage_details', constants::M_COMPONENT),
        3,
        $gradingsperpageoptions
    ));

    $settings->add(new admin_setting_configcheckbox(
        constants::M_COMPONENT . '/enablelocalpost',
        get_string('enablelocalpost', constants::M_COMPONENT),
        get_string('enablelocalpost_details', constants::M_COMPONENT),
        0
    ));
    ...
    $settings->add(new admin_setting_configtext(
        constants::M_COMPONENT . '/markscheme',
        get_string('markscheme', constants::M_COMPONENT),
        get_string('markscheme_help', constants::M_COMPONENT),
        'Deduct two marks for each grammar mistake.',
        PARAM_TEXT,
        100
    ));

    $settings->add(new admin_setting_configtext(
        constants::M_COMPONENT . '/feedbackscheme',
        get_string('feedbackscheme', constants::M_COMPONENT),
        get_string('feedbackscheme_help', constants::M_COMPONENT),
        'Explain each grammar mistake simply.',
        PARAM_TEXT,
        100
    ));
    ...
    $settings->add(new admin_setting_configselect(
        constants::M_COMPONENT . '/feedbacklanguage',
